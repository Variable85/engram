...
The instrument behind INSTALL-PI.md's "verified 19/19" — kept here so the claim
...
Exit 0 and `19/19 checks passed` is the pass state. Scratch state lives under
...
**Version notes:** 19/19 on pi 0.83.0 (Node ≥ 22.19) and pi 0.74.2 (the
