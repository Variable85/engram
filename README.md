...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.12.0-6D4AA8.svg" alt="Version 1.12.0">
...
Born as a Claude Code plugin; the same skills and engine now run on seven agentic platforms — including, as of v1.0.8, one that puts the tutor in your chat app, and, as of v1.12.0, both OpenCode generations (the 2.0 beta rebuilt its plugin API; Engram ships adapters for both in one package):
