...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/selftest-294%2F294-3E7D5A.svg" alt="294/294 checks">
...
| **`edit-node --topic T --node N`** | repair ONE node's grading contract in place — `--probe`, `--rubric-json`, `--transfer-probe`. Schedules, receipts and registrations are untouched; the node records that its contract moved and how many receipts predate it |
...
| `selftest` | 294 checks over the FSRS math, state machine, adherence/retention arithmetic, the grader-audit statistics, and every hardened boundary |
